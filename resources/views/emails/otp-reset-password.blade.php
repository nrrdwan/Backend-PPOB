...
<head>
    ...
    <style>
        /* Beberapa klien (Apple Mail, Gmail web) dukung ini; yang lain akan abaikan */
...
<body style="margin:0;padding:0;background:#f6f9fc;">
    ...
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;">
        Kode OTP untuk reset password {{ config('app.name') }}. Berlaku {{ $ttlSeconds ?? 60 }} detik.
    </div>

    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f6f9fc;">
        <tr>
            <td align="center" style="padding:24px;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="wrapper" style="max-width:600px;">
                    <tr>
                        <td>
                            <!-- Card -->
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="card"
                                ...
                                <tr>
                                    <td style="padding:20px 24px;border-bottom:1px solid #eef2f7;">
                                        <table role="presentation" width="100%">
                                            <tr>
                                                <td>
                                                    <div class="heading" style="font:600 18px ui-sans-serif, -apple-system, Segoe UI, Roboto, Helvetica, Arial; color:#111827;">
                                                        {{ config('app.name', 'PPOB System') }}
                                                    </div>
                                                    <div class="muted" style="margin-top:2px;font:400 12px ui-sans-serif, -apple-system, Segoe UI, Roboto, Helvetica, Arial;color:#6b7280;">
                                                        Reset Password
                                                    </div>
                                                </td>
                                                <td align="right">
                                ...
                                <tr>
                                    <td style="padding:24px;">
                                        <div class="text" style="font:400 14px/1.6 ui-sans-serif, -apple-system, Segoe UI, Roboto, Helvetica, Arial;color:#111827;">
                                            Halo <strong>{{ $name ?? $email ?? 'Pengguna' }}</strong>,<br><br>
                                            Kami menerima permintaan untuk mereset password akun Anda. Gunakan kode di bawah ini untuk melanjutkan.
                                        </div>
                                      ...
                                      letter-spacing:.18em;color:#0f172a;">
                                        ...
                                        <div class="muted"
                                            ...
                                            Kode berlaku {{ $ttlSeconds ?? 60 }} detik. Jangan bagikan kepada siapa pun.
                                        </div>

                                        <!-- Divider -->
                                        <div style="height:1px;background:linear-gradient(to right,transparent,#eaeaea,transparent);margin:24px 0;"></div>

                                        <!-- Notes -->
                                        <div class="text" style="font:400 13px/1.6 ui-sans-serif, -apple-system, Segoe UI, Roboto, Helvetica, Arial;color:#374151;">
                                            • Tim kami tidak akan pernah meminta OTP melalui telepon/chat.<br>
                                ...
                                <tr>
                                    <td style="padding:18px 24px;border-top:1px solid #eef2f7;" align="center">
                                        <div class="footnote" style="font:400 12px ui-sans-serif, -apple-system, Segoe UI, Roboto, Helvetica, Arial;color:#9ca3af;">
                                            Email otomatis
                                            @if(!empty($supportUrl) || !empty($supportEmail))
                                            <br>
                                            Butuh bantuan?
                                            @if(!empty($supportUrl))
                                            <a href="{{ $supportUrl }}" style="color:#6b7280;text-decoration:underline;">Pusat Bantuan</a>
                                            @endif
                ...
                <!-- Legal tiny -->
                <div style="margin-top:12px;font:400 11px ui-sans-serif, -apple-system, Segoe UI, Roboto, Helvetica, Arial;color:#9ca3af;">
